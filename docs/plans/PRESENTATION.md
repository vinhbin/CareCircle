...
**Resolution:** CareCircle gives every family a shared, multilingual care coordination tool — no language barrier.
...
**[Navigate: Support Circles page — show circle cards → click Diabetes Type 2]**

> *"But Bà Lan doesn't just need her family — she needs people who understand what she's going through. Support Circles connects her with other diabetes patients. A grandmother in Vietnam, a mother in Mexico, a father in India — all in one thread, each reading in their own language."*

*[Pause — let judges see the multilingual Q&A thread]*

> *"Bà Lan asks how to manage blood sugar after meals. Maria answers in Spanish. Priya shares a family recipe in Hindi. Everyone reads it in their own language. No translator needed."*
...
| **Support Circles (peer Q&A)** | Act 2 — circles page | **Wow moment #3** — multilingual peer support across languages |
| **Emergency QR card** | Act 3 — dashboard button | **Wow moment #4** — scannable by any paramedic |
...
- **Support Circles** — peer-to-peer patient Q&A across languages, like circle therapy without borders
...
- **Four wow moments:** Translation, photo scan, multilingual peer support, emergency QR card
...
- [ ] Support Circles page shows 3 circles, Diabetes Type 2 has full Q&A thread
